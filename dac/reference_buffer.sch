...
F 0 "R9" V 2400 3650 50  0000 C CNN
...
F 4 "C0G, loose tolerence here" H 2800 3650 50  0001 C CNN "Notes"
...
F 2 "TestPoint:TestPoint_Keystone_5000-5004_Miniature" H 9750 3900 50  0001 C CNN
...
F 4 "C0G, loose tolerence here" H 4750 5100 50  0001 C CNN "Notes"
...
The DAC reference is negative wrt. VCC (see dac sheet), so we want VCOM to\ntrack any variation in VCC_DAC.  Rather than re-referencing our output to some\nother +5 rail, we generate VCC_DAC by buffering our incoming +5 VREF (see power\nsheet).  Then DAC_VCC is itself a low noise reference which can be used to\ngenerate VCOM.\n\nVCC tracking happens in the R11/R12/C5 network, which is a combined voltage\ndivider and 15 Hz lowpass filter.  This filter insures that VCOM has low\nbroadband noise wrt VCC, tracking any noise on VCC.  This noise may be from\nVREF or possibly dumped into VCC from the DAC supply pins.\n
$Comp
L Device:R_US R?
U 1 1 5F829688
P 6950 4150
...
F 0 "R12" V 7050 4150 50  0000 C CNN
...
F 0 "#PWR0156" H 5850 4300 50  0001 C CNN
...
F 0 "#PWR0157" H 2800 3550 50  0001 C CNN
...
F 0 "#PWR0161" H 4650 2600 50  0001 C CNN
F 1 "GND" V 4650 2650 50  0000 C CNN
...
F 0 "#PWR0162" H 4650 3450 50  0001 C CNN
...
F 1 "OPA2210" H 3450 3650 60  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 4250 3450 60  0001 L CNN
F 3 "" H 4250 3550 60  0001 L CNN
F 4 "IC OPAMP 2 CIRCUIT" H 4250 4250 60  0001 L CNN "Description"
	1    4050 3250
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "U1" H 8250 4150 60  0000 C CNN
F 1 "OPA2210" H 8150 4250 60  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 8350 4150 60  0001 L CNN
F 3 "" H 8350 4250 60  0001 L CNN
F 4 "IC OPAMP 2 CIRCUIT" H 8350 4950 60  0001 L CNN "Description"
	2    8150 3950
	1    0    0    -1  
$EndComp
